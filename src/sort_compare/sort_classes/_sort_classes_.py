...
class MergeSort(SortingAlgorithm):
    def __init__(self):
        ...
        self.sort_func = self.sort_merg

    def sort_merg(self, arr):
        if len(arr) > 1:
            mid = len(arr) // 2
            left_half = arr[:mid]
            right_half = arr[mid:]

            self.sort_func(left_half)
            self.sort_func(right_half)
...
class InsertionSort(SortingAlgorithm):
    def __init__(self):
        ...
        self.sort_func = self.sort_insertion
...
class TimSort(SortingAlgorithm):
    def __init__(self):
        ...
        self.sort_func = self.sort_tim

    def sort_tim(self, arr):
        arr.sort()
